...
import 'package:flutter_weather_ntua/core/enums/location_status.dart';
  ...
  static Future<LocationInfo> getLocation() async {
    ...
    if (!serviceEnabled) {
      return const LocationInfo(
          locationStatus: LocationStatus.serviceUnavailable, geoModel: null);
    }
    ...
    if (permission == LocationPermission.denied) {
      ...
      if (permission == LocationPermission.denied) {
        return const LocationInfo(
            locationStatus: LocationStatus.denied, geoModel: null);
      }
    }
